...
export const useMySeriesProgress = (seriesName: string): UseMySeriesProgress => {
  ...
  const [seriesProgress, progressLoading, progressError, progressErrorMessage] = useUserSeriesProgress(username, seriesName);
  ...
  }, [seriesProgress, progressLoading, progressError, progressErrorMessage, usernameLoading, usernameError, usernameErrorMessage]);
};
